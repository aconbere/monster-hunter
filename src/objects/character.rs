...
impl fmt::Debug for CharacterFeatures {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f,  r#"CharacterFeatures: (
            name: {},
            gender: {},
            face: {},
            hair_style: {},
...
impl fmt::Debug for Character {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f,  r#"Character: (
            ...
            self.equipment_box_indexes,
            self.item_box.into_iter().take(20).collect::<Vec<_>>(),
            self.equipment_box.into_iter().take(20).collect::<Vec<_>>(),
            self.main_palico)
    }
}
